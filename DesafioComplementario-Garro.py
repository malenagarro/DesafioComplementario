...
# ## 7) SELECCIÓN DE MODELOS - CROSS VALIDATION
# Evaluaremos los modelos y determinaremos cual es el más eficiente para predecir los futuros casos de violencia, tanto la cantidad como los tipos. 
# 
...
# ##### 7) 2.1. TUNNING DE HIPERPARÁMTEROS
...
# ##### 7) 3. 1. TUNNING DE HIPERPARÁMETROS
...
# ## 8) SELECCION DEL MODELO Y ENTRENAMIENTO
# A partir de los resultados en cada Sprint, graficaremos el coeficiente de determinación y el MAE de cada uno y determinaremos aquel que arroje mejores valores.
# ### 8) 1. SELECCION DEL MODELO
